...
@Autonomous(name = "SRJA08", group = "")
@Disabled
public class SRJA08 extends OpMode {
...
//        angleReached = false;
    ...
    private Boolean detectImage() {
        ...
        if (imageDetected.equals("Quad")) {
            ...
            autoSequence.add((Void) -> strafeLeft(4, 0.75));
            autoSequence.add((Void) -> driveDistance(21, 0.75));
            autoSequence.add((Void) -> rotateRight(135, 0.75));
            autoSequence.add((Void) -> shooter(40, 95));
            autoSequence.add((Void) -> shooterLoader(60, 94));
            autoSequence.add((Void) -> shooterLoader(60, 87));
            autoSequence.add((Void) -> shooterLoader(60, 86));
            autoSequence.add((Void) -> shooterLoader(30, 95));
            autoSequence.add((Void) -> rotateLeft(135, 0.75));
            autoSequence.add((Void) -> strafeRight(17, 0.75));
            autoSequence.add((Void) -> rotateLeft(8, 0.5));
            autoSequence.add((Void) -> driveDistance(78, 0.75));
            autoSequence.add((Void) -> openArm());
            autoSequence.add((Void) -> driveDistanceBackwards(61, 0.75));
            autoSequence.add((Void) -> strafeRight(18, 0.75));
            autoSequence.add((Void) -> driveDistanceBackwards(21, 0.75));
            autoSequence.add((Void) -> rotateLeft(71, 0.5));
            autoSequence.add((Void) -> driveDistance(15.5, 0.75));
            autoSequence.add((Void) -> closeArm());
