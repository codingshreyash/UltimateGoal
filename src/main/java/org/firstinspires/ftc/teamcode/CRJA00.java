...
@Autonomous(name = "CRJA00", group = "")
@Disabled
public class CRJA00 extends OpMode {
...
//    }
    ...
    private Boolean detectImage() {
        ...
        if (imageDetected.equals("Quad")){
            autoSequence.add((Void) -> driveDistance(40, 0.5));
            autoSequence.add((Void) -> rotateLeft(90, 0.5));
        } else if(imageDetected.equals("Single")) {
            autoSequence.add((Void) -> driveDistance(50, 0.5));
            autoSequence.add((Void) -> rotateRight(90, 0.5));
        } else {
            autoSequence.add((Void) -> driveDistance(60, 0.5));
            autoSequence.add((Void) -> rotateRight(45, 0.5));
        }
        return true;
    }
