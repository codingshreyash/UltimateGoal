...
/* TELE-OP CLASS*/
@TeleOp(name = "SRJT15", group = "Opmode")
@Disabled
public class SRJT15 extends OpMode {
...
//0213    private DcMotor intakeTwo; //first set of intake to lift off
...
//0213    private double intakeTwoPower = .85;
...
//0213        intakeTwo = hardwareMap.get(DcMotor.class, "intakeTwo");
...
//0213        intakeTwo.setPower(0);
    ...
    public void drive() {
        ...
        //Gamepad2:
        sMotor.setVelocity(gamepad2.right_trigger * shooterPower);
...
//0213            intakeTwo.setPower(intakeTwoPower);
        }
