...
@Autonomous(name = "SRJA11", group = "")
public class SRJA11 extends OpMode {
    ...
    private Boolean detectImage() {
        ...
        if (imageDetected.equals("Quad")) {
            ...
            autoSequence.add((Void) -> closeArm());
            autoSequence.add((Void) -> driveDistanceBackwards(75, 60));
            autoSequence.add((Void) -> rotateLeft(90,50));
            autoSequence.add((Void) -> operateArmDown(7,25));
            autoSequence.add((Void) -> openArm());
            autoSequence.add((Void) -> driveDistanceBackwards(8,60));
            autoSequence.add((Void) -> rotateRight(90,40));
            autoSequence.add((Void) -> driveDistance(38.5,60));
            autoSequence.add((Void) -> closeArm());
            autoSequence.add((Void) -> driveDistanceBackwards(32,60));
            autoSequence.add((Void) -> rotateLeft(90,50));
            autoSequence.add((Void) -> driveDistance(15,60));
            autoSequence.add((Void) -> openArm());
            autoSequence.add((Void) -> driveDistanceBackwards(8,60));
            autoSequence.add((Void) -> rotateRight(92,50));
            autoSequence.add((Void) -> driveDistance(7,50));
            autoSequence.add((Void) -> strafeRight(27,50));
            autoSequence.add((Void) -> shooterLoader(48)); //shoot1
            autoSequence.add((Void) -> load(1));
            autoSequence.add((Void) -> delay(300));
            autoSequence.add((Void) -> load(0)); //pull back
            autoSequence.add((Void) -> delay(300));
            autoSequence.add((Void) -> strafeLeft(6.5,50));
            autoSequence.add((Void) -> shooterLoader(46)); //shoot1
            autoSequence.add((Void) -> load(1));
            autoSequence.add((Void) -> delay(300));
            autoSequence.add((Void) -> load(0)); //pull back
            autoSequence.add((Void) -> delay(300));
            autoSequence.add((Void) -> strafeLeft(7.5,50));
            autoSequence.add((Void) -> shooterLoader(46)); //shoot1
            autoSequence.add((Void) -> load(1));
            autoSequence.add((Void) -> delay(300));
            autoSequence.add((Void) -> load(0)); //pull back
            autoSequence.add((Void) -> delay(300));
            autoSequence.add((Void) -> rotateLeft(180,40));
            autoSequence.add((Void) -> closeArm());
            autoSequence.add((Void) -> intakePosition()); //move down
            autoSequence.add((Void) -> blockerDown());
        }
