...
@Autonomous(name = "SRJA06", group = "")
@Disabled
public class SRJA06 extends OpMode {
...
//        angleReached = false;
    ...
    private Boolean detectImage() {
        ...
        if (imageDetected.equals("Quad")) {
            ...
            // autoSequence.add((Void) -> operateArmDown(7, .35)); // down is postive
         //   autoSequence.add((Void) -> openArm());
         //   autoSequence.add((Void) -> closeArm());
           // autoSequence.add((Void) -> operateArmUp(7.1, .50)); // UP = 8.1 and DOWN = 7
           //autoSequence.add((Void) -> driveDistanceBackwards(34, .50));
