...
@Autonomous(name = "SRJA12", group = "")
public class SRJA12 extends LinearOpMode {
    ...
    drive = new SampleMecanumDrive(hardwareMap);
        ...
        Trajectory hitPowerShot1 = drive.trajectoryBuilder(readyToPowerShot.end())
                .lineToLinearHeading(new Pose2d (1.8289579176576949, -25.287730999860404, Math.toRadians(183.47382556103395)))
                .build();

        Trajectory hitPowerShot2 = drive.trajectoryBuilder(hitPowerShot1.end())
                .lineToLinearHeading(new Pose2d(2.8073895618576676, -33.5920184737995, Math.toRadians(184.23776855932152)))
                .build();

        Trajectory hitPowerShot3 = drive.trajectoryBuilder(hitPowerShot2.end())
                .lineToLinearHeading(new Pose2d(3.509232979799914, -39.16947603389731, Math.toRadians(182.8371972888754)))
                .build();

        Trajectory moveToEndSpot = drive.trajectoryBuilder(hitPowerShot3.end())
                .lineToLinearHeading(new Pose2d(13.992, -28.252, Math.toRadians(0)))
                .build();

        Trajectory moveToRightSideOfRings = drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineTo(new Vector2d(-28.893558389154883, -76.89757969683169))
                .build();

        Trajectory shootingTopGoal = drive.trajectoryBuilder(moveToRightSideOfRings.end())
                .lineTo(new Vector2d(6.561961817739956, -57.25490095350667))
                .build();
        ...
        Trajectory moveToDropWG1 = drive.trajectoryBuilder(rotateFor1Ring.end())
                .lineToLinearHeading(new Pose2d(30.224, -30.8002009279735589, Math.toRadians(0)))
                .build();
        ...
        Trajectory getSecondWobble1 = drive.trajectoryBuilder(hitPowerShot3.end())
                .lineToLinearHeading(new Pose2d(-31.00177411916484, -47.52361762768403, Math.toRadians(186.33013235154147)))
                .build();

        Trajectory moveToDropWG12 = drive.trajectoryBuilder(getSecondWobble1.end())
                .lineToLinearHeading(new Pose2d(28.224, -30.8002009279735589, Math.toRadians(0)))
                .build();
