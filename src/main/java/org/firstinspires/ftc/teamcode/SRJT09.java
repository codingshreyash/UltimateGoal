...
/* TELE-OP CLASS*/
@TeleOp(name = "SRJT09", group = "Opmode")
@Disabled
public class SRJT09 extends OpMode {
...
//            }
//
//            if (servoTwo.getPosition() == 1) {
//                servoTwo.setPosition(0);
//            } else {
//                servoTwo.setPosition(1);
//            }

            telemetry.addData("Button Pressed A", "a");
            telemetry.update();
        }


        //telemetry.addData("servoOne Position", servoOne.getPosition());
        //telemetry.addData("servoTwo Position", servoTwo.getPosition());
        telemetry.update();
